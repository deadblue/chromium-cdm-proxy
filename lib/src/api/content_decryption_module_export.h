...
#ifndef CDM_PROXY_CONTENT_DECRYPTION_MODULE_EXPORT_H
#define CDM_PROXY_CONTENT_DECRYPTION_MODULE_EXPORT_H
...
#endif //CDM_PROXY_CONTENT_DECRYPTION_MODULE_EXPORT_H
